...
boxplot(list(Naive=sizeFactors(sce_naive), Primed=sizeFactors(sce_primed)), 
    log="y", ylab="Size factors")
```
...
```{r}
downprop <- median(sizeFactors(sce_primed))/median(sizeFactors(sce_naive))
downprop
set.seed(1000)
