...
Checking for coorrelations between Ferdinand's hand-curated markers and various epigenetic modifiers/readers of interest.
First we load in the data.

```{r}
chosen_markers <- read.csv("miscellaneous/ferd_marker_set.csv", stringsAsFactors = FALSE)
head(chosen_markers)
chosen_markers <- inPresentSet(rowData(sce_primed)$ensembl_gene_id, chosen_markers[,1])
