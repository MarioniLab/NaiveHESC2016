...
plotPCA(sce[,sce$phenotype == 'primed'], exprs_values="norm_exprs", colour_by = rownames(primed.hvg[1,])) + fontsize
plotTSNE(sce[,sce$phenotype == 'primed'], exprs_values="norm_exprs", colour_by=rownames(primed.hvg[1,]),
...
pca_primed <- plotPCA(sce[,sce$phenotype == 'primed'], exprs_values="norm_exprs", colour_by = rownames(sce)[endo_markers][2], feature_set = rownames(sce)[endo_markers]) + fontsize
pca_naive <- plotPCA(sce[,sce$phenotype == 'naive'], exprs_values="norm_exprs", colour_by = rownames(sce)[endo_markers][2], feature_set = rownames(sce)[endo_markers]) + fontsize
multiplot(pca_primed, pca_naive, cols=2)

pca_primed <- plotPCA(sce[,sce$phenotype == 'primed'], exprs_values="norm_exprs", colour_by = rownames(sce)[ecto_markers][2], feature_set = rownames(sce)[ecto_markers]) + fontsize
pca_naive <- plotPCA(sce[,sce$phenotype == 'naive'], exprs_values="norm_exprs", colour_by = rownames(sce)[ecto_markers][2], feature_set = rownames(sce)[ecto_markers]) + fontsize
multiplot(pca_primed, pca_naive, cols=2)

pca_primed <- plotPCA(sce[,sce$phenotype == 'primed'], exprs_values="norm_exprs", colour_by = rownames(sce)[meso_markers][2], feature_set = rownames(sce)[meso_markers]) + fontsize
pca_naive <- plotPCA(sce[,sce$phenotype == 'naive'], exprs_values="norm_exprs", colour_by = rownames(sce)[meso_markers][2], feature_set = rownames(sce)[meso_markers]) + fontsize
multiplot(pca_primed, pca_naive, cols=2)
