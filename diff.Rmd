...
pca_naive <- plotPCA(sce_naive, exprs_values="norm_exprs", colour_by = "CCNA1", rerun=TRUE) + fontsize
tsne_naive <- plotTSNE(sce_naive, exprs_values="norm_exprs", colour_by= "CCNA1",  rerun=TRUE,
    perplexity=5, rand_seed=100) + fontsize

pca_primed <- plotPCA(sce_primed, exprs_values="norm_exprs", colour_by = "CCNA1", rerun=TRUE) + fontsize
tsne_primed <- plotTSNE(sce_primed, exprs_values="norm_exprs", colour_by= "CCNA1",  rerun=TRUE,
    perplexity=5, rand_seed=100) + fontsize
