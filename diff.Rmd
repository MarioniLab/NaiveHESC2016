...
sce_naive <- runTSNE(sce_naive, use_dimred="PCA", perplexity=5, exprs_values="norm_exprs", set.seed=100)
sce_primed <- runTSNE(sce_primed, use_dimred="PCA", perplexity=5, exprs_values="norm_exprs", set.seed=100)
...
pca_naive <- plotPCA(sce_naive, colour_by = "CDK1", rerun=TRUE) + fontsize
tsne_naive <- plotTSNE(sce_naive, colour_by= "CDK1", rerun=TRUE) + fontsize

pca_primed <- plotPCA(sce_primed, colour_by = "CDK1", rerun=TRUE) + fontsize
tsne_primed <- plotTSNE(sce_primed, colour_by= "CDK1", rerun=TRUE) + fontsize
...
```{r}
sce_naive <- runTSNE(sce_naive, use_dimred="PCA", perplexity=5, exprs_values="norm_exprs", set.seed=100, feature_set = lin.markers)
...
```{r}
#mesoderm
pca_naive <- plotPCA(sce_naive, colour_by = 'SNAI1', rerun=TRUE) + fontsize
tsne_naive <- plotTSNE(sce_naive, colour_by= "SNAI1", rerun = TRUE) + fontsize
multiplot(pca_naive, tsne_naive)
saveRDS(tsne_naive, file = file.path(resdir, 'naive_tsne1.Rds'))

#ectoderm
pca_naive <- plotPCA(sce_naive, colour_by = 'NES', rerun=TRUE) + fontsize
tsne_naive <- plotTSNE(sce_naive, colour_by= "NES", rerun=TRUE) + fontsize
multiplot(pca_naive, tsne_naive)
saveRDS(tsne_naive, file = file.path(resdir, 'naive_tsne2.Rds'))

#endoderm
pca_naive <- plotPCA(sce_naive, colour_by = 'GATA4', rerun=TRUE) + fontsize
tsne_naive <- plotTSNE(sce_naive, colour_by= "GATA4", rerun=TRUE) + fontsize
multiplot(pca_naive, tsne_naive)
...
```{r}
sce_primed <- runTSNE(sce_primed, use_dimred="PCA", perplexity=5, exprs_values="norm_exprs", set.seed=100, feature_set = lin.markers)
...
```{r}
#mesoderm
pca_primed <- plotPCA(sce_primed, colour_by = 'SNAI1', rerun=TRUE) + fontsize
tsne_primed <- plotTSNE(sce_primed, colour_by= "SNAI1", rerun=TRUE) + fontsize
multiplot(pca_primed, tsne_primed)
saveRDS(tsne_primed, file = file.path(resdir, 'primed_tsne1.Rds'))

#ectoderm
pca_primed <- plotPCA(sce_primed, colour_by = 'NES', rerun=TRUE) + fontsize
tsne_primed <- plotTSNE(sce_primed, colour_by= "NES", rerun=TRUE) + fontsize
multiplot(pca_primed, tsne_primed)
saveRDS(tsne_primed, file = file.path(resdir, 'primed_tsne2.Rds'))

#endoderm
pca_primed <- plotPCA(sce_primed, colour_by = 'GATA4', rerun=TRUE) + fontsize
tsne_primed <- plotTSNE(sce_primed, colour_by= "GATA4", rerun=TRUE) + fontsize
multiplot(pca_primed, tsne_primed)
