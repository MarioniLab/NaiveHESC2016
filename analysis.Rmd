...
par(mfrow=c(2,2))
plot(density(naive.props["het",], na.rm = T), main = "Allosome", xlab = "Proportion of hets on X", xlim = c(0, 0.1), col = "#e79f00")
mtext(text = paste0("mean naive: ", round(mean(naive.props["het",], na.rm = T), digits = 3), " | mean primed: ", round(mean(primed.props["het",], na.rm = T), digits = 3)), c(3))
lines(density(primed.props["het",], na.rm = T), main = "Primed", xlab = "Proportion of hets on X", xlim = c(0, 0.12), col = "#0072B2")
legend("topright", legend = c("Primed", "Naive"), pch=16,  col = c("#0072B2", "#e79f00"), bty = "n")

plot(density(naive.props["snpcalls",], na.rm = T), main = "Allosome", xlab = "Proportion of hets on X", xlim = c(0, 0.13), col = "#e79f00", ylim = c(0,20))
mtext(text = paste0("mean naive: ", round(mean(naive.props["snpcalls",], na.rm = T), digits = 3), " | mean primed: ", round(mean(primed.props["snpcalls",], na.rm = T), digits = 3)), c(3))
lines(density(primed.props["snpcalls",], na.rm = T), main = "Primed", xlab = "Proportion of hets on X", xlim = c(0, 0.12), col = "#0072B2")
legend("topright", legend = c("Primed", "Naive"), pch=16,  col = c("#0072B2", "#e79f00"), bty = "n")

plot(density(naive.auto["het",], na.rm = T), main = "Autosome", xlab = "Proportion of hets on X", col = "#e79f00")
mtext(text = paste0("mean naive: ", round(mean(naive.auto["het",], na.rm = T), digits = 3), " | mean primed: ", round(mean(primed.auto["het",], na.rm = T), digits = 3)), c(3))
lines(density(primed.auto["het",], na.rm = T), main = "Primed", xlab = "Proportion of hets on X", xlim = c(0, 0.12), col = "#0072B2")
legend("topright", legend = c("Primed", "Naive"), pch=16,  col = c("#0072B2", "#e79f00"), bty = "n")

plot(density(naive.auto["snpcalls",], na.rm = T), main = "Autosome", xlab = "Proportion of hets on X", col = "#e79f00", ylim = c(0,15))
mtext(text = paste0("mean naive: ", round(mean(naive.auto["snpcalls",], na.rm = T), digits = 3), " | mean primed: ", round(mean(primed.auto["snpcalls",], na.rm = T), digits = 3)), c(3))
lines(density(primed.auto["snpcalls",], na.rm = T), main = "Primed", xlab = "Proportion of hets on X", xlim = c(0, 0.12), col = "#0072B2")
legend("topright", legend = c("Primed", "Naive"), pch=16,  col = c("#0072B2", "#e79f00"), bty = "n")
```
