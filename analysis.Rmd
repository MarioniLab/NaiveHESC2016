...
par(mfrow=c(2,2))
plot(density(naive.props["het",], na.rm = T), main = "Naive", xlab = "Proportion of hets on X", xlim = c(0, 0.12))
mtext(text = paste0("mean: ", round(mean(naive.props["het",], na.rm = T), digits = 3)), c(3))
plot(density(primed.props["het",], na.rm = T), main = "Primed", xlab = "Proportion of hets on X", xlim = c(0, 0.12))
mtext(text = paste0("mean: ", round(mean(primed.props["het",], na.rm = T), digits = 3)), c(3))

plot(density(naive.props["snpcalls",], na.rm = T), main="", xlab = "Proportion of het X SNP calls", xlim = c(0, 0.12))
mtext(text = paste0("mean: ", round(mean(naive.props["snpcalls",], na.rm = T), digits = 3)), c(3))
plot(density(primed.props["snpcalls",], na.rm = T), main="", xlab = "Proportion of het X SNP calls", xlim = c(0, 0.12))
mtext(text = paste0("mean: ", round(mean(primed.props["snpcalls",], na.rm = T), digits = 3)), c(3))
```
