...
multiplot(cols=2, 
    plotPhenoData(sce, aes(x = sample, y = total_counts)),
    plotPhenoData(sce, aes(x = sample, y = total_features)))
```
...
multiplot(cols=2, 
    plotPhenoData(sce, aes(x=sample, y=pct_counts_feature_controls_Mito)),
    plotPhenoData(sce, aes(x=sample, y=pct_counts_feature_controls_Spike)))
```
