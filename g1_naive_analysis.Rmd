...
sce_naive <- runTSNE(sce_naive, exprs_values="norm_exprs", perplexity=5, feature_set=chosen_naive)
...
sce_naive <- runPCA(sce_naive, exprs_values="norm_exprs", perplexity=10, feature_set = chosen_naive)
