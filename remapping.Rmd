...
```{r kable}
library("knitr")
escs <- c("Human ESCs", "Mouse ESCs", "Monkey ESCs")
Authors <- c("Petropoulos et al.", "Mohammed & Reik", "Nakamura et al.")
Paper <- c("Single-Cell RNA-Seq Reveals Lineage and X Chromosome Dynamics in Human Preimplantation Embryos", "Not yet published", "A developmental coordinate of pluripotency among mice, monkeys and humans.")
Journal <- c("Cell. 2016", "tba. 2017", "Nature. 2016")
Datatype <- c(".txt", ".txt", ".txt")
Url <- c("http://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-3929", "tba.", "https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE74767")
annotable <- data.frame(Authors, Paper, Journal, Datatype, Url, row.names = escs)
kable(annotable)
```
