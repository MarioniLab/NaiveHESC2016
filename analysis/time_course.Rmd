...
par(mfrow=c(1,3))
plot(props[1,], main=rownames(props)[1], xaxt = 'n', xlab = '', pch = 16, col = cols, cex = 1.5)
axis(1, c(2,5,8,11), labels = c(0,1,2,3), ylab = 'Coefficient')
plot(props[2,], main=rownames(props)[2], xaxt = 'n', xlab = 'Day', pch = 16, col = cols, cex = 1.5)
axis(1, c(2,5,8,11), labels = c(0,1,2,3), ylab = '')
plot(props[3,], main=rownames(props)[3], xaxt = 'n', xlab = '', pch = 16, col = cols, cex = 1.5)
axis(1, c(2,5,8,11), labels = c(0,1,2,3), ylab = '')
#dev.off()
```
