...
sce_naive <- denoisePCA(sce_naive, var.out_naive, value="pca", assay.type="norm_exprs")
```
...
sce_primed <- denoisePCA(sce_primed, var.out_primed, value="pca", assay.type="norm_exprs")
```
...
lin.sce_naive <- runPCA(lin.sce_naive, exprs_values = "norm_exprs")
...
lin.sce_primed <- runPCA(lin.sce_primed, exprs_values = "norm_exprs")
